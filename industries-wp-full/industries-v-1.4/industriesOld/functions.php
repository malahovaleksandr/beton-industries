...
function industries_enqueue_scripts() {
	$theme_options = _WSH()->option();
	$maincolor = str_replace( '#', '' , industries_set( $theme_options, 'main_color_scheme', '#fac012' ) );
    //styles
	...
	wp_enqueue_style( 'industries-main-color', get_template_directory_uri() . '/css/color.php?main_color='.$maincolor );
	wp_enqueue_style( 'industries-color-panel', get_template_directory_uri() . '/css/color-panel.css' );
