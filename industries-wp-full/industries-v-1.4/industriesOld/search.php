<?php industries_bunch_global_variable();
	...
	$layout = industries_set( $settings, 'search_page_layout', 'right' );
	$sidebar = industries_set( $settings, 'search_page_sidebar', 'blog-sidebar' );
	...
	$bg = industries_set($settings, 'search_page_header_img');
	$title = industries_set($settings, 'search_page_header_title');
?>
		...
		<div class="rw">
			...
			<?php else : ?>
                <div class="<?php echo esc_attr($classes);?> blog_post_area eco-search">
                    <p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'industries' ); ?></p>
