...
<section class="our-team <?php if( $style_two == true ) echo 'padd-80' ;?>">
	<div class="container">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6">
				<div class="single-team-member">
					<figure class="img-box">
						<a href="<?php echo esc_url(industries_set($team_meta, 'ext_url'));?>"><?php the_post_thumbnail('industries_270x225');?></a>
					</figure>
					...
					<div class="text"><p><?php echo balanceTags(industries_trim(get_the_content(), $text_limit));?></p></div>
